...
import {
  LayoutDashboard, GitBranch, GitCommitHorizontal, Network, Flame,
  Building2, Users, Brain, Settings, ChevronLeft, ChevronRight,
  Activity, Search, Hexagon,
} from "lucide-react";
    ...
    >
      ...
      {!collapsed && (
        <div className="px-3 py-3">
          <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 text-muted-foreground text-xs">
            ...
            <span>Search...</span>
            <kbd className="ml-auto px-1.5 py-0.5 rounded bg-white/5 text-[10px] font-mono">⌘K</kbd>
          </div>
        </div>
      )}
      ...
      {!collapsed && (
        <div className="px-3 py-3 mx-3 mb-3 rounded-xl bg-gradient-to-br from-cyan-500/10 to-transparent border border-cyan-500/10">
          ...
          <p className="text-[10px] text-muted-foreground mt-1">73/100 — Good</p>
        </div>
      )}
